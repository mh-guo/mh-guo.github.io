...
As a computational astrophysicist, I use innovative numerical simulations to study the rich physics from galactic scales all the way down to the event horizon of black holes. 
...
<figure>
  <img src="/images/fig_amh_edge.png" alt="Zoom-in MHD simulation edge-on view" style="width:100%; height:auto;">
  <figcaption> Edge-on view of the zoom-in MHD simulation of black hole accretion and feedback (red: mass density, blue: energy density for gas with Bernoulli parameter larger than 4).</figcaption>
</figure>
